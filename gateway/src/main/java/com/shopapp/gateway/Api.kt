...
interface Api {
    ...
    fun getProducts(perPage: Int, paginationValue: Any? = null, sortBy: SortType? = null,
    ...
    fun searchProducts(perPage: Int, paginationValue: Any? = null, query: String,
                       callback: ApiCallback<List<Product>>)

    // Categories

    fun getCategories(perPage: Int, paginationValue: Any?, parentCategoryId: String?,
                      callback: ApiCallback<List<Category>>)

    fun getCategory(id: String, perPage: Int, paginationValue: Any?, sortBy: SortType? = null,
                    callback: ApiCallback<Category>)

    // Articles

    fun getArticles(perPage: Int, paginationValue: Any?, sortBy: SortType? = null,
    ...
    fun updateCustomer(firstName: String, lastName: String, phone: String,
    ...
    fun setShippingRate(checkoutId: String, shippingRate: ShippingRate,
                        callback: ApiCallback<Checkout>)

    fun completeCheckoutByCard(checkout: Checkout, email: String, address: Address,
