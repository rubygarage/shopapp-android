...
import com.client.shop.ui.details.di.OrderDetailsModule
...
class OrderDetailsActivity :
        BaseActivity<Product, OrderDetailsView, DetailsPresenter>(),
        OrderDetailsView,
    ...
    override fun inject() {
        ShopApplication.appComponent.attachDetailsComponent(OrderDetailsModule()).inject(this)
    }
