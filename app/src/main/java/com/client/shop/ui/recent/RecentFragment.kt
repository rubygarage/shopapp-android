...
import com.client.shop.ui.base.ui.recycler.divider.StartSpaceDecoration
...
class RecentFragment :
    ...
    private fun setupRecycler() {
        ...
        val decoration = StartSpaceDecoration(resources.getDimensionPixelSize(R.dimen.content_space))
